...
clone="git clone https://github.com/WhatsBotAR/Whats_Bot"
clone2="https://github.com/WhatsBotAR/Whats_Bot"
...
choose ()
{
  ...
  if [ "$LANGUAGE_SELECT" -eq "$LANGAR" ]; then
...
starting
metadata
if_meta https://github.com/WhatsBotAR/Whats_Bot
