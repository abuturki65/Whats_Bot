...
async function whatsAsena () {
    ...
    setInterval(async () => { 
        ...
        while (getGMTh == 19 && getGMTm == 1) {
            var ilan = ''
            if (config.LANG == 'AR') ilan = '[ ```الإعلانات اليومية``` ]\n\n'
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((OWN.ff == "9647815029347,0" && msg.key.fromMe === false && command.fromMe === true &&
