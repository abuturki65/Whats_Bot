...
if (conf.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'لنص', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    Asena.addCommand({ pattern: 'لنص', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
