...
let msg = Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*تمت الموافقة رسميًا على هذا الملـف الإضافي!* ✅' : '*This Plugin is Officially Approved!* ✅'
let unmsg = Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*هـذا الملـف الاضـافي غير رسمـي!* ❌' : '*This Plugin isn\'t Officially Approved!* ❌'
...
var LANG = {
            unaffinfo: Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*مستـوى الخطر الخاص بالملـف الإضافـي المثبت:* _%' : '*Danger Level of Installed Plugin:* _%',
            harmful: Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*لا يمكن تثبيت هذا الملـف الاضـافي لأنه ضـار!*' : '*This Plugin Cannot Be Installed As It Is Harmful!*',
            duplicate: Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*لا يمكنك تثبيت نفس الملـف الاضـافي مرتين!*' : '*You Cannot Install the Same Plugin 2 Times!*',
            limit: Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*هـذا الملـف الاضـافي يتجاوز حد الأمـان!*\n*نسبـة الخطـر:* _%' : '*This Plugin Exceeds Security Limit!*\n*Percentage of Harm:* _%',
            imside: Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*لا يمكنك إعـادة تحميل الإضافـات الموجـودة!*' : '*You Cant Reinstall Existing Plugins!*'
};
