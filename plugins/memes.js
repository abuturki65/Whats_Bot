...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'ميمي ?(.*)', fromMe: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
    ...
    Asena.addCommand({pattern: 'ميمي ?(.*)', fromMe: false, desc: Lang.MEMES_DESC}, (async (message, match) => {    
