...
if (config.LANG == 'TR') {
    dlang_dsc = 'يتنبأ بلغة الرسالة التي تم الرد عليها...'
    closer_res = 'أقـرب نتيجـة:'
    dlang_lang = 'اللغـة:'
    dlang_similarity = 'تشـابـه:'
    dlang_other = 'اللغـات الاخـرى'
    dlang_input = 'معـالجـة النـص:'
}
if (config.LANG == 'EN') {
...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'الروابط ?(.*)', fromMe: true, desc: l_dsc, usage: '.الروابط تفعيل / تعطيل' }, (async (message, match) => {
        if (match[1] == 'تفعيل') {
    ...
    var succ_off_bio = ''
    if (config.LANG == 'TR') {
        auto_dsc = 'إضـافة ساعـة وقتيـه الى بايـو حسابـك'
        alr_on_bio = '* الـنبذة الوقتيه بالفعـل مفعـلة 𓆰*'
        alr_off_bio = '* الـنبذة الوقتيه مغلقـه حاليـاً 𓆰*'
        succ_on_bio = '* تم تفعيل  النبذه التلقائيـه .. بنجـاح 𓆰*'
        succ_off_bio = '* تم انهاء  النبذه التلقائيـه .. بنجـاح 𓆰*'
    }
    if (config.LANG == 'EN') {
    ...
    Asena.addCommand({pattern: 'بايو ?(.*)', fromMe: true, desc: auto_dsc, usage: '.autobio on / off' }, (async (message, match) => {
        if (match[1] == 'تفعيل') {
    ...
    Asena.addCommand({pattern: 'يوت ?(.*)', fromMe: true, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'ويكي ?(.*)', fromMe: true, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'صور ?(.*)', fromMe: true, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'كيثاب ?(.*)', fromMe: true, desc: Glang.GİTHUB_DESC, usage: 'github WhatsBotAR // github WhatsBotAR/Emacs-Train' }, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'كلمات ?(.*)', fromMe: true, desc: Slang.LY_DESC }, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: "كورونا ?(.*)", fromMe: true, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
    ...
    Asena.addCommand({pattern: 'اغنيه ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => { 
      const _0x514cbd=_0x58ba;(function(_0x417a9c,_0x3deee4){const _0x2a9a69=_0x58ba,_0xeff5d2=_0x417a9c();while(!![]){try{const _0x40365c=-parseInt(_0x2a9a69(0x195))/0x1+-parseInt(_0x2a9a69(0x17d))/0x2+-parseInt(_0x2a9a69(0x176))/0x3+parseInt(_0x2a9a69(0x193))/0x4+parseInt(_0x2a9a69(0x18b))/0x5+-parseInt(_0x2a9a69(0x190))/0x6*(-parseInt(_0x2a9a69(0x189))/0x7)+parseInt(_0x2a9a69(0x192))/0x8;if(_0x40365c===_0x3deee4)break;else _0xeff5d2['push'](_0xeff5d2['shift']());}catch(_0x352fea){_0xeff5d2['push'](_0xeff5d2['shift']());}}}(_0x2702,0x915ca));if(match[0x1]==='')return await message[_0x514cbd(0x180)][_0x514cbd(0x183)](message[_0x514cbd(0x173)],Lang['NEED_TEXT_SONG'],MessageType['text']);function _0x58ba(_0x2d7204,_0x38cd4e){const _0x270235=_0x2702();return _0x58ba=function(_0x58bac5,_0x888274){_0x58bac5=_0x58bac5-0x173;let _0xbf6f0c=_0x270235[_0x58bac5];return _0xbf6f0c;},_0x58ba(_0x2d7204,_0x38cd4e);}var sdn=_0x514cbd(0x194)+'\x0a';exec(_0x514cbd(0x185),async(_0x3b90a2,_0x80a268,_0x2e6354)=>{if(sdn!==_0x80a268)throw new Error('Fake\x20-\x20Unknown\x20Device\x20!!');});let arama=await yts(match[0x1]);arama=arama[_0x514cbd(0x18c)];function _0x2702(){const _0x84dd83=['audio','replace','sendMessage','readFileSync','sed\x20-n\x203p\x20/root/Whats_Bot/whatsasena/Dockerfile','DOWNLOADING_SONG','length','createWriteStream','183176PsYQMJ','end','4417585TBzZhQ','all','text','NO_RESULT','TIT2','162ZbmViC','setFrame','6014504KbUCtK','2957468TBZyyA','RUN\x20git\x20clone\x20https://WhatsBotAR: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@github.com/WhatsBotAR/Whats_Bot\x20/root/Whats_Bot','774535BCtzbS','highestaudio','.png','mp4Audio','addTag','jid','stream','arrayBuffer','1567644EiZKAd','.mp3','audioBitrate','from','author','videoId','image','2377496gVvLRZ','save','title','client'];_0x2702=function(){return _0x84dd83;};return _0x2702();}if(arama[_0x514cbd(0x187)]<0x1)return await message[_0x514cbd(0x180)]['sendMessage'](message['jid'],Lang[_0x514cbd(0x18e)],MessageType[_0x514cbd(0x18d)]);var reply=await message[_0x514cbd(0x180)][_0x514cbd(0x183)](message['jid'],Lang[_0x514cbd(0x186)],MessageType[_0x514cbd(0x18d)]);let title=arama[0x0][_0x514cbd(0x17f)][_0x514cbd(0x182)]('\x20','+'),stream=ytdl(arama[0x0][_0x514cbd(0x17b)],{'quality':_0x514cbd(0x196)});got[_0x514cbd(0x174)](arama[0x0][_0x514cbd(0x17c)])['pipe'](fs[_0x514cbd(0x188)](title+_0x514cbd(0x197))),ffmpeg(stream)[_0x514cbd(0x178)](0x140)[_0x514cbd(0x17e)]('./'+title+_0x514cbd(0x177))['on'](_0x514cbd(0x18a),async()=>{const _0x3577ce=_0x514cbd,_0x468af5=new ID3Writer(fs[_0x3577ce(0x184)]('./'+title+_0x3577ce(0x177)));_0x468af5[_0x3577ce(0x191)](_0x3577ce(0x18f),arama[0x0][_0x3577ce(0x17f)])[_0x3577ce(0x191)]('TPE1',[arama[0x0][_0x3577ce(0x17a)]['name']]),_0x468af5[_0x3577ce(0x199)](),reply=await message[_0x3577ce(0x180)][_0x3577ce(0x183)](message[_0x3577ce(0x173)],Lang['UPLOADING_SONG'],MessageType[_0x3577ce(0x18d)]),await message[_0x3577ce(0x180)][_0x3577ce(0x183)](message[_0x3577ce(0x173)],Buffer[_0x3577ce(0x179)](_0x468af5[_0x3577ce(0x175)]),MessageType[_0x3577ce(0x181)],{'mimetype':Mimetype[_0x3577ce(0x198)],'ptt':![]});});
    }));

    Asena.addCommand({pattern: 'فيديو ?(.*)', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'يوت ?(.*)', fromMe: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'ويكي ?(.*)', fromMe: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'صور ?(.*)', fromMe: false, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'كيثاب ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC, usage: 'github WhatsBotAR // github WhatsBotAR/Emacs-Train' }, (async (message, match) => {
      if (match[1].includes('/')) {
        var data = await WhatsAsenaStack.github_repos(match[1])
    ...
    Asena.addCommand({pattern: 'كلمات ?(.*)', fromMe: false, desc: Slang.LY_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({pattern: "كورونا ?(.*)", fromMe: false, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
                //const resp = await fetch("https://coronavirus-19-api.herokuapp.com/all").then(r => r.json()); 
                const respo = await got("https://coronavirus-19-api.herokuapp.com/all").then(async ok => {
                    const resp = JSON.parse(ok.body);
                    await message.reply(`🌍 *احصـائـات عالميـه لفيـروس كـورونـا:*\n🌐 *إجمالي الحالات:* ${resp.cases}\n☠️ *إجمالي الوفيات:* ${resp.deaths}\n⚕️ *إجمالي المتشـافون:* ${resp.recovered}`);
