...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'x4mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {caption: '- تـم الانشـاء بواسطـة ⪼ 𝗪𝗵𝗮𝘁𝘀_𝗕𝗼𝘁🔆'});
            });
    ...
    Asena.addCommand({pattern: 'mp4image', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: '- تـم الانشـاء بواسطـة ⪼ 𝗪𝗵𝗮𝘁𝘀_𝗕𝗼𝘁🔆'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'bwimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.png')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.png'), MessageType.image, {mimetype: Mimetype.png, caption: '- تـم الانشـاء بواسطـة ⪼ 𝗪𝗵𝗮𝘁𝘀_𝗕𝗼𝘁🔆'});
        });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    Asena.addCommand({pattern: 'gif', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output_gif.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output_gif.mp4'), MessageType.video, {mimetype: Mimetype.gif, caption: '- تـم الانشـاء بواسطـة ⪼ 𝗪𝗵𝗮𝘁𝘀_𝗕𝗼𝘁🔆'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
        ...
        exec('ffprobe -hide_banner -loglevel fatal -show_error -show_format -show_streams -show_programs -show_chapters -show_private_data -print_format json ' + location, async (err, st, stderr) => {
            ...
            ffmpeg(location)
                ...
                .on('progress', async (progress) => {
                    ...
                    while (l > 10 && dam == 10) {
                        dam = 1
                        let yon = Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*%10 Tamamlandı!*' : '*Completed %10!*'
                    ...
                    while (l > 30 && dam == 1) {
                        dam = 2
                        let yotuz = Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*%30 Tamamlandı!*' : '*Completed %30!*'
                    ...
                    while (l > 50 && dam == 2) {
                        dam = 3
                        let yelli = Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*%50 Tamamlandı!*' : '*Completed %50!*'
                    ...
                    while (l > 70 && dam == 3) {
                        dam = 4
                        let yetmis = Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*%70 Tamamlandı!*' : '*Completed %70!*'
                    ...
                    while (l > 90 && dam == 4) {
                        dam = 5
                        let vprocc = Config.LANG == 'AR' || Config.LANG == 'AZ' ? '*Video Hazırlanıyor..*' : '*Preparing Video..*'
