...
Asena.addCommand({pattern: 'اطردني$', fromMe: true, desc: Lang.KICKME_DESC, onlyGroup: true}, (async (message, match) => {
...
Asena.addCommand({ pattern: 'ضع بايو ?(.*)', fromMe: true, desc: dsc }, (async (message, match) => { 
...
Asena.addCommand({pattern: 'حضر ?(.*)', fromMe: true, desc: Lang.BLOCK_DESC}, (async (message, match) => {   
...
Asena.addCommand({pattern: 'الغاء حضر ?(.*)', fromMe: true, desc: Lang.UNBLOCK_DESC}, (async (message, match) => { 
