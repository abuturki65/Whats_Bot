...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'تسجيل', fromMe: true, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'تسجيل', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'تسجيل', fromMe: true, desc: Lang.UV_DESC, dontAddCommandList: true}, (async (message, match) => {    
