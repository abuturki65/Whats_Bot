...
var cmd = ''
var cmd_desc = ''
if (Config.LANG == 'TR') description = '- يعـرض كل أوامـر تحـويـلات النصـوص الـى ملصقـات ⌨---🎇', cmd = '*الامـر:* ', cmd_desc = '*الوصـف:* '
...
Asena.addCommand({ pattern: 'allttp$', fromMe: wk, desc: description }, (async (message, match) => {
  ...
  var t3 = Config.LANG == 'TR' || Config.LANG == 'AZ' ? "يحول النـص إلى ملصـق ذو طابـع مائـي...🏞" : "Converts text to water-themed sticker."
  var t4 = Config.LANG == 'TR' || Config.LANG == 'AZ' ? "يحول النـص إلى ملصـق الكتابـة باليـد...🙌" : "Converts text to hand writing sticker."
  var t5 = Config.LANG == 'TR' || Config.LANG == 'AZ' ? "يحول النـص إلى ملصـق ذي طابع البـلاك بيرد...👽" : "Converts text to blackbird-themed sticker."
