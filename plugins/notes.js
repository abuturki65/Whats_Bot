...
Asena.addCommand({ pattern: 'حفظ ?(.*)', fromMe: true, desc: Lang.SAVE_USAGE }, async (message, match) => {
...
Asena.addCommand({ pattern: 'مسح الحافظه', fromMe: true, desc: Lang.DELETE_USAGE }, async (message, match) => {
