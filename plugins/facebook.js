...
var CLR_DESC = ''
var wr = ''
if (Config.LANG == 'TR') CLR_DESC = 'تحميـل مقاطـع الفيديـو مـن فيـس بـوك', wr = '*فقـط قـم بارسـال رابـط الفيديـو*'
...
Asena.addCommand({pattern: 'فيس ?(.*)', fromMe: wk, desc: CLR_DESC, usage: 'fb https://www.facebook.com/Google/videos/10156367314197838'}, (async (message, match) => {
