...
var FR_USER = ''
var OTHER = ''
if (CON.LANG == 'AR') ADMİN_USER = '*Admin Sayısı:*', USER_USER = '*Üye Sayısı:*', TR_USER = '*Türk Üye Sayısı:*', Hİ_USER = '*Hint Üye Sayısı:*', AZ_USER = '*Azeri Üye Sayısı:*', SRİ_USER = '*Sri Lanka Üye Sayısı:*', RU_USER = '*Rus Üye Sayısı:*', USA_USER = '*ABD Üye Sayısı:*', OTHER = '*Diğer Üye Sayısı:*', FR_USER = '*Fransız Üye Sayısı:*'
...
if (CON.WORKTYPE == 'private') {
    Asena.addCommand({ pattern: 'ايدي$', fromMe: true, desc: Lang.PL_DESC }, async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'ايدي$', fromMe: false, desc: Lang.PL_DESC }, async (message, match) => { 
        if (message.jid.includes('-')) {
            var json = await message.client.groupMetadataMinimal(message.jid) 
            var code = await message.client.groupInviteCode(message.jid)
            var nwjson = await message.client.groupMetadata(message.jid) 
