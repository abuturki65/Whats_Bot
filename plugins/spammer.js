...
Asena.addCommand({pattern: 'ايقاف_التكرار', fromMe: true, desc: Lang.STOP_SPAMDESC}, (async (message, match) => {
...
Asena.addCommand({pattern: 'تكرار ?(.*)', fromMe: true, desc: Lang.SPAM_DESC}, (async (message, match) => {
