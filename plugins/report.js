...
if (Config.WORKTYPE == 'private') {
    Asena.addCommand({pattern: 'بلاغ ?(.*)', fromMe: true, desc: Lang.REPORT}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'بلاغ ?(.*)', fromMe: false, desc: Lang.REPORT}, (async (message, match) => {
        if (match[1] == '' && message.reply_message) {
            let grup = await message.client.groupMetadata(message.jid);
            var jids = [];
            mesaj = '';
    ...
    Asena.addCommand({pattern: 'بلاغ ?(.*)', fromMe: true, desc: Lang.REPORT, dontAddCommandList: true}, (async (message, match) => {
        if (match[1] == '' && message.reply_message) {
            let grup = await message.client.groupMetadata(message.jid);
            var jids = [];
            mesaj = '';
