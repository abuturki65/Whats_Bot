...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'نيكو', fromMe: true, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'نيكو', fromMe: false, desc: Lang.NEKO_DESC}, (async (message, match) => {
