...
var description = ''
var bit = ''
if (Config.LANG == 'TR') description = 'تحـويلات وحـدات الـوزن.', bit = 'تحـويلات وحـدات البيانـات.'
...
Asena.addCommand({pattern: 'وحده ?(.*)', fromMe: wk, desc: description, usage: 'وحده 1 kg mg // وحده <الرقم> <الوحده الاولى> <الوحده الثانيه>'}, (async (message, match) => {
...
Asena.addCommand({pattern: 'وحدة ?(.*)', fromMe: wk, desc: bit, usage: 'وحدة 1 gb mg // وحدة <الرقم> <الوحده الاولى> <الوحده الثانيه>'}, (async (message, match) => {
  var splitted_text = match[1].split(' ')
